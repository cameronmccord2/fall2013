...
string Input::getTokensValueString() const {
    return characters.substr(currentTokensStartLocation + 1, currentCharacterLocation - currentTokensStartLocation - 1);
};
